...
namespace EchoBot1
{
    ...
    public class ConversationStateAccessors
    {
        ...
        public ConversationStateAccessors(ConversationState conversationState)
        {
        ...
        public static string CounterStateName { get; } = $"{nameof(ConversationStateAccessors)}.CounterState";
        ...
        /// </value>
        public IStatePropertyAccessor<SelectedLanguageState> SelectedLanguage { get; set; }

        /// <summary>
        /// Gets the <see cref="IStatePropertyAccessor{T}"/> name used for the <see cref="CounterState"/> accessor.
        /// </summary>
        /// <remarks>Accessors require a unique name.</remarks>
        /// <value>The accessor name for the selected language accessor.</value>
        public static string SelectedLanguageName { get; } = $"{nameof(ConversationStateAccessors)}.SelectedLanguage";
